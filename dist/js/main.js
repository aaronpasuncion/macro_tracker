...
var UIController = (function () {
  ...
  return {
    ...
    displayDashboard: function () {
      var welcomeSection, welcomeContainer, dashboard;
    ...
    displayTotalMacrosForm: function () {
      var header, text, welcomeSection, welcomeContainer, dashboard;
      welcomeSection = document.querySelector(DOMstrings.welcomeSection);
      welcomeContainer = document.querySelector(DOMstrings.welcomeContainer);
      dashboard = document.querySelector(DOMstrings.dashboardContainer);
      ...
      dashboard.style.animation = "dash-slide-down 1s forwards";
    ...
    foodLogOriginalState: function () {
      var foodLog, foodForm, interfaceMessage;
      foodLog = document.querySelector(DOMstrings.foodLogContainer);
      foodForm = document.querySelector(DOMstrings.itemContainer);
    ...
    displayNewItem: function (obj, objPerentages) {
      ...
      foodTitle =
        obj.name.length >= 12 ? obj.name.substr(0, 12) + "..." : obj.name;
    ...
    displayMessage: function (message, type) {
      ...
      if (type === "success") {
        ...
        setTimeout(function () {
          document
            .querySelector(".interface-message")
            .classList.add("fade-out");
          // after the fade out, remove the message block
          setTimeout(function () {
            document.querySelector(".interface-message").style.display = "none";
          }, 5000);
        }, 5000);
      } else if (type === "error") {
        // add the error message above the form
...
var Controller = (function (FoodCtrl, UICtrl) {
  ...
  var ctrlEditTotalMacros = function () {
    ...
    UICtrl.displayTotalMacrosForm(event, currentMacros);
  };
  // Delete Food Item
